...
The second one is the function that exists in the "pn53x.c" and  calls the first, the first function contains all the logic but it doesn't exists in the "pn53x.h" 

5- now go to nfc.h and add these:
